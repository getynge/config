...
function cptemplate() { 
  mkdir "$CODE_DIRECTORY/$2"
  cp -r "$TEMPLATES_DIRECTORY/$1/*" "$CODE_DIRECTORY/$2/"
}
...
# aliases
alias emake="cmake . -DCMAKE_EXPORT_COMPILE_COMMANDS=1"
...
[ -f "/Users/getynge/.ghcup/env" ] && source "/Users/getynge/.ghcup/env" # ghcup-env
